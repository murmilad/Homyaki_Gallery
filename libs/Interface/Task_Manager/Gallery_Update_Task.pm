package Homyaki::Interface::Task_Manager::Gallery_Update_Task;
...
use constant TASK_HANDLER => 'Homyaki::Task_Manager::Task::Gallery_Update';
use constant RESUME_PATH  => '/media/MEIZU M8';
                            # /media/MEIZU\ M8/Gallery/resume.txt
...
sub get_helper {
	...
	$body->add_form_element(
		...
		value  => 'This task updates http://akosarev.info gallery.',
	);
...
sub set_params {
	...
	my $result = $params;
		...
		my @task_types = Homyaki::Task_Manager::DB::Task_Type->search(
			handler => 'Homyaki::Task_Manager::Task::Gallery_Update'
		);
